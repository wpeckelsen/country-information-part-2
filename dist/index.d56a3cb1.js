...
async function countryInfoFunction() {
    try {
        const countryInfoResult = await _axiosDefault.default.get("https://restcountries.com/v2/all");
...
function regionColorFunction(country) {
    if (country === "Asia") return "asia";
    else if (country === "europe") return "europe";
    else if (country === "africa") return "africa";
    else if (country === "oceania") return "oceania";
    else if (country === "americas") return "americas";
}
